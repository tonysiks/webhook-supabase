...
module.exports = {
  ...
  notanotherwholesale: {
    ...
    mapProduct: (p) => ({
      title:      p.title || null,
      url:        p.source?.canonicalUrl || null,
      price:      p.variants?.[0]?.price?.current != null ? Math.round(p.variants[0].price.current / 100 * 0.860 * 100) / 100 : null,
      image_url:  p.medias?.[0]?.url || null,
      variant_title: p.variants?.[0]?.title || null,
      category:   p.categories?.[0] || null,
      tags:       normalizeTags(p.tags),
  ...
  laprovidence: {
    ...
    mapProduct: (p) => ({
      title:      p.title || null,
      url:        p.source?.canonicalUrl || null,
      price:      p.variants?.[0]?.price?.current != null ? Math.round(p.variants[0].price.current / 100 * 0.610 * 100) / 100 : null,
      image_url:  p.medias?.[0]?.url || null,
      variant_title: p.variants?.[0]?.title || null,
      category:   p.categories?.[0] || null,
      tags:       normalizeTags(p.tags),
  ...
  vintagesupplyco: {
    ...
    mapProduct: (p) => ({
      url:        p.source?.canonicalUrl || null,
      title:      p.title || null,
      price:      p.variants?.[0]?.price?.current != null ? Math.round(p.variants[0].price.current / 100 * 0.740 * 100) / 100 : null,
      image_url:  p.medias?.[0]?.url || null,
      variant_title: p.variants?.[0]?.title || null,
      stockStatus: p.variants?.[0]?.stockStatus || null,
